...
class UpdateDrugRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $drugId = $drug instanceof Drug ? $drug->id : $drug;
        ...
        return [
            'generic_name' => [
                ...
                'string',
                'max:255',
                Rule::unique(Drug::class, 'generic_name')->ignore($drugId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'generic_name.unique' => 'Another drug already uses this generic name.',
